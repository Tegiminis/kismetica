...
class Rampage(Script): 
    ...
    def at_script_creation(self):
        ...
        self.interval = 60           # Amount of time until buff falls off
    ...
    def at_start(self):
        ...
        self.obj.db.damage['mult'] += self.db.mult * self.db.stacks
        self.db.msg['send'] = self.db.msg['start'] % self.db.stacks
